...
void Scop_Device::createCommandPool() {
...
void Scop_Device::setupDebugMessenger() {
...
bool Scop_Device::checkValidationLayerSupport() {
  uint32_t layerCount;
...
void Scop_Device::hasGflwRequiredInstanceExtensions() {
...
VkCommandBuffer Scop_Device::beginSingleTimeCommands() {
...
void Scop_Device::createImageWithInfo(
